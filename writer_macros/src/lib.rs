...
/// ### `merge_damage!`
///
/// Has two similar variants. Returns a Vec<String> with length = 5 that is generated by
/// the closure passed as first argument. This closure can take or not arguments, and
/// the value it returns will be inserted into the Vec.
///
///
/// ```
