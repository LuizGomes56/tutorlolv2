...
pub static RUNE_ID_TO_RIOT_ID: [u32; 72] = [
    9994, 8233, 9101, 9990, 8214, 8439, 8410, 9992, 8224, 8345, 8473, 8321, 8234, 8126, 8229, 8429,
    8010, 8347, 8014, 8017, 8128, 8141, 8446, 8112, 8120, 8369, 8021, 8463, 8236, 8136, 8351, 8437,
    8140, 8465, 9923, 9993, 9991, 8306, 8316, 8299, 9104, 9103, 9105, 8008, 8304, 8226, 9996, 8275,
    8451, 8230, 8124, 8009, 8005, 8105, 8453, 8237, 8444, 8401, 8137, 8143, 8139, 9995, 8352, 8210,
...
impl RuneId {
    ...
    pub const fn from_riot_id(id: u32) -> Self {
        match id {
            9994 => Self::AbilityHaste,
            8233 => Self::AbsoluteFocus,
            9101 => Self::AbsorbLife,
            9990 => Self::AdaptiveForce,
            8214 => Self::Aery,
            8439 => Self::Aftershock,
            8410 => Self::ApproachVelocity,
            9992 => Self::AttackSpeed,
            8224 => Self::AxiomArcanist,
            8345 => Self::BiscuitDelivery,
            8473 => Self::BonePlating,
            8321 => Self::CashBack,
            8234 => Self::Celerity,
            8126 => Self::CheapShot,
            8229 => Self::Comet,
            8429 => Self::Conditioning,
            8010 => Self::Conqueror,
            8347 => Self::CosmicInsight,
            8014 => Self::CoupdeGrace,
            8017 => Self::CutDown,
            8128 => Self::DarkHarvest,
            8141 => Self::DeepWard,
            8446 => Self::Demolish,
            8112 => Self::Electrocute,
            8120 => Self::EyeballCollection,
            8369 => Self::FirstStrike,
            8021 => Self::FleetFootwork,
            8463 => Self::FontofLife,
            8236 => Self::GatheringStorm,
            8136 => Self::GhostPoro,
            8351 => Self::GlacialAugment,
            8437 => Self::Grasp,
            8140 => Self::GrislyMementos,
            8465 => Self::Guardian,
            9923 => Self::HailofBlades,
            9993 => Self::Health,
            9991 => Self::HealthScaling,
            8306 => Self::HextechFlashtraption,
            8316 => Self::JackOfAllTrades,
            8299 => Self::LastStand,
            9104 => Self::LegendAlacrity,
            9103 => Self::LegendBloodline,
            9105 => Self::LegendHaste,
            8008 => Self::LethalTempo,
            8304 => Self::MagicalFootwear,
            8226 => Self::ManaflowBand,
            9996 => Self::MoveSpeed,
            8275 => Self::NimbusCloak,
            8451 => Self::Overgrowth,
            8230 => Self::PhaseRush,
            8124 => Self::Predator,
            8009 => Self::PresenceofMind,
            8005 => Self::PressTheAttack,
            8105 => Self::RelentlessHunter,
            8453 => Self::Revitalize,
            8237 => Self::Scorch,
            8444 => Self::SecondWind,
            8401 => Self::ShieldBash,
            8137 => Self::SixthSense,
            8143 => Self::SuddenImpact,
            8139 => Self::TasteofBlood,
            9995 => Self::TenacityandSlowResist,
            8352 => Self::TimeWarpTonic,
            8210 => Self::Transcendence,
            8135 => Self::TreasureHunter,
            8313 => Self::TripleTonic,
            9111 => Self::Triumph,
            8106 => Self::UltimateHunter,
            8242 => Self::Unflinching,
            8360 => Self::UnsealedSpellbook,
            8232 => Self::Waterwalking,
            8138 => Self::ZombieWard,
            _ => Self::AbilityHaste,
        }
    }
}
pub static INTERNAL_RUNES: [&CachedRune; 72] = [
    &ABILITY_HASTE_9994,
    &ABSOLUTE_FOCUS_8233,
    &ABSORB_LIFE_9101,
    &ADAPTIVE_FORCE_9990,
...
pub static DAMAGING_RUNES: phf::Set<u32> = phf::phf_set!(
    8214u32, 8439u32, 8126u32, 8229u32, 8128u32, 8112u32, 8437u32, 8124u32, 8005u32, 8237u32,
    8143u32
);
