        ...
        impl ChampionId {
            ...
            pub const fn from_u8(id: u8) -> Option<Self> {
                ...
                attributes: Attrs::Undefined 
                    ...
                    merge_data: &[(2, 6),(9, 10),(4, 8),(1, 5),(3, 7)],
                ...
                attributes: Attrs::Undefined 
                    ...
                    closures: &[|ctx| { match ctx.level as u8 {1 => 15f32 + 0.6f32 * ctx.ap,2 => 15f32 + 0.6f32 * ctx.ap,3 => 15f32 + 0.6f32 * ctx.ap,4 => 15f32 + 0.6f32 * ctx.ap,5 => 15f32 + 0.6f32 * ctx.ap,6 => 15f32 + 0.6f32 * ctx.ap,7 => 40f32 + 0.6f32 * ctx.ap,8 => 40f32 + 0.6f32 * ctx.ap,9 => 40f32 + 0.6f32 * ctx.ap,10 => 40f32 + 0.6f32 * ctx.ap,11 => 40f32 + 0.6f32 * ctx.ap,12 => 80f32 + 0.6f32 * ctx.ap,13 => 80f32 + 0.6f32 * ctx.ap,14 => 80f32 + 0.6f32 * ctx.ap,15 => 80f32 + 0.6f32 * ctx.ap,16 => 80f32 + 0.6f32 * ctx.ap,17 => 150f32 + 0.6f32 * ctx.ap,18 => 150f32 + 0.6f32 * ctx.ap,_ => 0.0 }},|ctx| { match ctx.q_level {1 => 5f32 + 0.8f32 * ctx.ad,2 => 25f32 + 0.8f32 * ctx.ad,3 => 45f32 + 0.8f32 * ctx.ad,4 => 65f32 + 0.8f32 * ctx.ad,5 => 85f32 + 0.8f32 * ctx.ad,_ => 0.0 }},|ctx| { match ctx.q_level {1 => 10f32 + 1.6f32 * ctx.ad,2 => 50f32 + 1.6f32 * ctx.ad,3 => 90f32 + 1.6f32 * ctx.ad,4 => 130f32 + 1.6f32 * ctx.ad,5 => 170f32 + 1.6f32 * ctx.ad,_ => 0.0 }},|ctx| { match ctx.r_level {1 => (25f32 + 0.15f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),2 => (30f32 + 0.15f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),3 => (35f32 + 0.15f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),_ => 0.0 }},|ctx| { match ctx.r_level {1 => (125f32 + 0.75f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),2 => (210f32 + 0.9f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),3 => (315f32 + 1.05f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),_ => 0.0 }},|ctx| { match ctx.r_level {1 => (75f32 + 0.45f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),2 => (90f32 + 0.45f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),3 => (105f32 + 0.45f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),_ => 0.0 }},|ctx| { match ctx.r_level {1 => (375f32 + 2.25f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),2 => (630f32 + 2.7f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),3 => (945f32 + 3.15f32 * ctx.ad) * (1f32 + ctx.crit_chance / 200f32),_ => 0.0 }}],
