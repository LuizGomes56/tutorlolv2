...
pub static CHAMPION_ID_TO_INDEX: phf::OrderedMap<&'static str, ChampionId> = phf::phf_ordered_map!(
    ...
    "Khazix" => ChampionId::Khazix,
    "Kindred" => ChampionId::Kindred,
    "Kled" => ChampionId::Kled,
    "KogMaw" => ChampionId::KogMaw,
    "KSante" => ChampionId::KSante,
    "Leblanc" => ChampionId::Leblanc,
    "LeeSin" => ChampionId::LeeSin,
    ...
    "MasterYi" => ChampionId::MasterYi,
    "Mel" => ChampionId::Mel,
    "Milio" => ChampionId::Milio,
    "MissFortune" => ChampionId::MissFortune,
    "MonkeyKing" => ChampionId::MonkeyKing,
    ...
    "RekSai" => ChampionId::RekSai,
    "Rell" => ChampionId::Rell,
    "Renata" => ChampionId::Renata,
    ...
    "TahmKench" => ChampionId::TahmKench,
    ...
    "TwistedFate" => ChampionId::TwistedFate,
