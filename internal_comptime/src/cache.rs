        ...
        paste::paste! {
            impl AbilityLike {
                pub fn [<from_str_ $field>](s: &str) -> &'static str {
                    match s {
                        concat!(stringify!([<$field:upper>]), "1") => "AbilityName::_1",
                        concat!(stringify!([<$field:upper>]), "2") => "AbilityName::_2",
                        concat!(stringify!([<$field:upper>]), "3") => "AbilityName::_3",
                        concat!(stringify!([<$field:upper>]), "4") => "AbilityName::_4",
                        concat!(stringify!([<$field:upper>]), "5") => "AbilityName::_5",
                        concat!(stringify!([<$field:upper>]), "6") => "AbilityName::_6",
                        concat!(stringify!([<$field:upper>]), "7") => "AbilityName::_7",
                        concat!(stringify!([<$field:upper>]), "8") => "AbilityName::_8",
                        concat!(stringify!([<$field:upper>]), "MEGA") => "AbilityName::Mega",
                        concat!(stringify!([<$field:upper>]), "MAX") => "AbilityName::Max",
                        concat!(stringify!([<$field:upper>]), "MIN") => "AbilityName::Min",
                        concat!(stringify!([<$field:upper>]), "MNX") => "AbilityName::Minion",
                        concat!(stringify!([<$field:upper>]), "MN1") => "AbilityName::Minion1",
                        concat!(stringify!([<$field:upper>]), "MN2") => "AbilityName::Minion2",
                        concat!(stringify!([<$field:upper>]), "MN3") => "AbilityName::Minion3",
                        concat!(stringify!([<$field:upper>]), "MMNX") => "AbilityName::MinionMax",
                        concat!(stringify!([<$field:upper>]), "MSTR") => "AbilityName::Monster",
                        concat!(stringify!([<$field:upper>]), "MST1") => "AbilityName::Monster1",
                        concat!(stringify!([<$field:upper>]), "MST2") => "AbilityName::Monster2",
                        concat!(stringify!([<$field:upper>]), "MST3") => "AbilityName::Monster3",
                        concat!(stringify!([<$field:upper>]), "MST4") => "AbilityName::Monster4",
                        concat!(stringify!([<$field:upper>]), "MMST") => "AbilityName::MonsterMax",
                        stringify!([<$field:upper>]) => "AbilityName::Void",
                        concat!(stringify!([<$field:upper>]), "MAX1") => "AbilityName::_1Max",
                        concat!(stringify!([<$field:upper>]), "MAX2") => "AbilityName::_2Max",
                        concat!(stringify!([<$field:upper>]), "MAX3") => "AbilityName::_3Max",
                        concat!(stringify!([<$field:upper>]), "MAX4") => "AbilityName::_4Max",
                        concat!(stringify!([<$field:upper>]), "MAX5") => "AbilityName::_5Max",
                        concat!(stringify!([<$field:upper>]), "MAX6") => "AbilityName::_6Max",
                        concat!(stringify!([<$field:upper>]), "MAX7") => "AbilityName::_7Max",
                        concat!(stringify!([<$field:upper>]), "MAX8") => "AbilityName::_8Max",
                        concat!(stringify!([<$field:upper>]), "MIN1") => "AbilityName::_1Min",
                        concat!(stringify!([<$field:upper>]), "MIN2") => "AbilityName::_2Min",
                        concat!(stringify!([<$field:upper>]), "MIN3") => "AbilityName::_3Min",
                        concat!(stringify!([<$field:upper>]), "MIN4") => "AbilityName::_4Min",
                        concat!(stringify!([<$field:upper>]), "MIN5") => "AbilityName::_5Min",
                        concat!(stringify!([<$field:upper>]), "MIN6") => "AbilityName::_6Min",
                        concat!(stringify!([<$field:upper>]), "MIN7") => "AbilityName::_7Min",
                        concat!(stringify!([<$field:upper>]), "MIN8") => "AbilityName::_8Min",
                        _ => "AbilityName::Void"
                    }
                }
