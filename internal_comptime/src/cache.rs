                    ...
                    match self {
                        AbilityLike::[<$field:upper>](v) => {
                            match v {
                                ...
                                AbilityName::Minion1 => stringify!(concat!($field, "MN1")),
                                AbilityName::Minion2 => stringify!(concat!($field, "MN2")),
                                AbilityName::Minion3 => stringify!(concat!($field, "MN3")),
                                AbilityName::MinionMax => stringify!(concat!($field, "MMNX")),
                                AbilityName::Monster => stringify!(concat!($field, "MSTR")),
                                AbilityName::Monster1 => stringify!(concat!($field, "MST1")),
                                AbilityName::Monster2 => stringify!(concat!($field, "MST2")),
                                AbilityName::Monster3 => stringify!(concat!($field, "MST3")),
                                AbilityName::Monster4 => stringify!(concat!($field, "MST4")),
                                AbilityName::MonsterMax => stringify!(concat!($field, "MMST")),
                                AbilityName::Void => stringify!($field),
