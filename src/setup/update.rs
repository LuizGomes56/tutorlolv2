...
pub fn load_cache() -> GlobalCache {
    ...
    let meta_items = read_from_file::<MetaItems>("internal/meta_items.json");
    ...
    let runes = read_from_file::<HashMap<usize, Rune>>("internal/runes.json");
