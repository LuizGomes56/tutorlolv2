...
pub fn run_writer_file(path_name: &str, cdn_value: Option<CdnChampion>) -> Result<(), SetupError> {
    let result: CdnChampion = match cdn_value {
        Some(value) => value,
        None => read_json_file(path_name)
